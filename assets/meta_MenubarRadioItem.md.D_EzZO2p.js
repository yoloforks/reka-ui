import{_ as o,c as r,e,au as t,o as i}from"./chunks/framework.6UEeBrHH.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/MenubarRadioItem.md","filePath":"meta/MenubarRadioItem.md","lastUpdated":1741142384000}'),s={name:"meta/MenubarRadioItem.md"};function d(p,l,c,m,h,u){const n=t("PropsTable"),a=t("EmitsTable");return i(),r("div",null,[e(n,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
...
`,type:"string",required:!0}]}),e(a,{data:[{name:"select",description:`<p>Event handler called when the user selects an item (via mouse or keyboard). <br>
Calling <code>event.preventDefault</code> in this handler will prevent the menu from closing when selecting that item.</p>
`,type:"[event: Event]"}]})])}const v=o(s,[["render",d]]);export{b as __pageData,v as default};
