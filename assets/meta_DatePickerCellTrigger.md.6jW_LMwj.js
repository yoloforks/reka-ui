import{_ as r,c as o,e,au as t,o as i}from"./chunks/framework.BvEsjwOO.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/DatePickerCellTrigger.md","filePath":"meta/DatePickerCellTrigger.md","lastUpdated":1741141490000}'),s={name:"meta/DatePickerCellTrigger.md"};function p(d,l,c,m,u,h){const a=t("PropsTable"),n=t("SlotsTable");return i(),o("div",null,[e(a,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
...
`,type:"DateValue",required:!0}]}),e(n,{data:[{name:"dayValue",description:`<p>Current day</p>
...
`,type:"boolean"}]})])}const C=r(s,[["render",p]]);export{g as __pageData,C as default};
