import{_ as o,c as r,e,au as t,o as s}from"./chunks/framework.6UEeBrHH.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/MenubarCheckboxItem.md","filePath":"meta/MenubarCheckboxItem.md","lastUpdated":1741142384000}'),d={name:"meta/MenubarCheckboxItem.md"};function i(p,l,c,m,h,u){const n=t("PropsTable"),a=t("EmitsTable");return s(),r("div",null,[e(n,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
...
`,type:"string",required:!1}]}),e(a,{data:[{name:"select",description:`<p>Event handler called when the user selects an item (via mouse or keyboard). <br>
...
`,type:"[payload: boolean]"}]})])}const v=o(d,[["render",i]]);export{b as __pageData,v as default};
