import{_ as d,c as r,e,au as t,o as l}from"./chunks/framework.6UEeBrHH.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/DateFieldRoot.md","filePath":"meta/DateFieldRoot.md","lastUpdated":1741142901000}'),s={name:"meta/DateFieldRoot.md"};function p(c,h,u,m,f,y){const a=t("PropsTable"),n=t("EmitsTable"),o=t("SlotsTable"),i=t("MethodsTable");return l(),r("div",null,[e(a,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
...
`,type:"[date: DateValue]"}]}),e(o,{data:[{name:"modelValue",description:`<p>The current date of the field</p>
...
`,type:"boolean"}]}),e(i,{data:[{name:"isDateUnavailable",description:`<p>A function that returns whether or not a date is unavailable</p>
`,type:"Matcher"},{name:"setFocusedElement",description:`<p>Helper to set the focused element inside the DateField</p>
`,type:"(el: HTMLElement) => void"}]})])}const v=d(s,[["render",p]]);export{g as __pageData,v as default};
