import{_ as d,c as r,e,au as t,o as l}from"./chunks/framework.6UEeBrHH.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/TimeFieldRoot.md","filePath":"meta/TimeFieldRoot.md","lastUpdated":1741142384000}'),s={name:"meta/TimeFieldRoot.md"};function p(m,c,u,h,f,T){const a=t("PropsTable"),i=t("EmitsTable"),n=t("SlotsTable"),o=t("MethodsTable");return l(),r("div",null,[e(a,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
