import{_ as i,c as r,e,au as t,o as s}from"./chunks/framework.6UEeBrHH.js";const w=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/SwitchRoot.md","filePath":"meta/SwitchRoot.md","lastUpdated":1741142901000}'),d={name:"meta/SwitchRoot.md"};function p(l,c,m,h,u,f){const a=t("PropsTable"),o=t("EmitsTable"),n=t("SlotsTable");return s(),r("div",null,[e(a,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
...
`,type:"string",required:!1,default:"'on'"}]}),e(o,{data:[{name:"update:modelValue",description:`<p>Event handler called when the value of the switch changes.</p>
`,type:"[payload: boolean]"}]}),e(n,{data:[{name:"modelValue",description:`<p>Current value</p>
`,type:"boolean"}]})])}const _=i(d,[["render",p]]);export{w as __pageData,_ as default};
