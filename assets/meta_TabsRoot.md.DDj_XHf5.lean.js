import{_ as r,c as i,e,au as t,o as d}from"./chunks/framework.6UEeBrHH.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/TabsRoot.md","filePath":"meta/TabsRoot.md","lastUpdated":1741142901000}'),s={name:"meta/TabsRoot.md"};function l(p,c,m,u,h,f){const a=t("PropsTable"),o=t("EmitsTable"),n=t("SlotsTable");return d(),i("div",null,[e(a,{data:[{name:"activationMode",description:`<p>Whether a tab is activated automatically (on focus) or manually (on click).</p>
