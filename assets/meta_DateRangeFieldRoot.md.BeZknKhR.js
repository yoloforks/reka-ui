import{_ as i,c as d,e,au as t,o as l}from"./chunks/framework.6UEeBrHH.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/DateRangeFieldRoot.md","filePath":"meta/DateRangeFieldRoot.md","lastUpdated":1741142384000}'),s={name:"meta/DateRangeFieldRoot.md"};function p(c,m,h,u,f,g){const a=t("PropsTable"),n=t("EmitsTable"),o=t("SlotsTable"),r=t("MethodsTable");return l(),d("div",null,[e(a,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
