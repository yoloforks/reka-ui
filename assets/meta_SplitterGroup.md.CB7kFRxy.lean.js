import{_ as n,c as p,e,au as t,o as s}from"./chunks/framework.BvEsjwOO.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/SplitterGroup.md","filePath":"meta/SplitterGroup.md","lastUpdated":1741141490000}'),i={name:"meta/SplitterGroup.md"};function d(l,u,c,m,f,h){const a=t("PropsTable"),o=t("EmitsTable"),r=t("SlotsTable");return s(),p("div",null,[e(a,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
