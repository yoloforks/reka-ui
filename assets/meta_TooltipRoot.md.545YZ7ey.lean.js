import{_ as i,c as r,e,au as o,o as s}from"./chunks/framework.6UEeBrHH.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/TooltipRoot.md","filePath":"meta/TooltipRoot.md","lastUpdated":1741142901000}'),p={name:"meta/TooltipRoot.md"};function l(d,c,m,h,u,f){const t=o("PropsTable"),n=o("EmitsTable"),a=o("SlotsTable");return s(),r("div",null,[e(t,{data:[{name:"defaultOpen",description:`<p>The open state of the tooltip when it is initially rendered.
