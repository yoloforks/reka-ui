...
`)),n[138]||(n[138]=e("span",{class:"line"},[e("span",{style:{color:"#E1E4E8"}},"</"),e("span",{style:{color:"#85E89D"}},"template"),e("span",{style:{color:"#E1E4E8"}},">")],-1))])])]),n[145]||(n[145]=p("",3)),o(i,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
...
`,type:"boolean"}]}),o(d,{data:[{attribute:"[data-state]",values:["checked","unchecked"]},{attribute:"[data-disabled]",values:"Present when disabled"}]}),n[146]||(n[146]=p("",2)),o(i,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
...
<p>Read our <a href='https://www.reka-ui.com/docs/guides/composition'>Composition</a> guide for more details.</p>
`,type:"boolean",required:!1}]}),o(d,{data:[{attribute:"[data-state]",values:["checked","unchecked"]},{attribute:"[data-disabled]",values:"Present when disabled"}]}),n[147]||(n[147]=p("",3)),o(f,{data:[{keys:["Space"],description:"Toggles the component's state."},{keys:["Enter"],description:"Toggles the component's state."}]})])}}});export{Q as __pageData,Y as default};
