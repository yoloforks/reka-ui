import{_ as d,c as l,e,au as t,o as r}from"./chunks/framework.DhAtJbM3.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/EditableRoot.md","filePath":"meta/EditableRoot.md","lastUpdated":1741141824000}'),s={name:"meta/EditableRoot.md"};function p(c,h,u,m,f,b){const i=t("PropsTable"),a=t("EmitsTable"),n=t("SlotsTable"),o=t("MethodsTable");return r(),l("div",null,[e(i,{data:[{name:"activationMode",description:`<p>The activation event of the editable field</p>
