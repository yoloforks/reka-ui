import{_ as i,c as a,e,au as t,o as r}from"./chunks/framework.6UEeBrHH.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/ContextMenuContent.md","filePath":"meta/ContextMenuContent.md","lastUpdated":1741142901000}'),s={name:"meta/ContextMenuContent.md"};function d(p,l,c,h,u,m){const n=t("PropsTable"),o=t("EmitsTable");return r(),a("div",null,[e(n,{data:[{name:"alignOffset",description:`<p>An offset in pixels from the <code>start</code> or <code>end</code> alignment options.</p>
...
regardless.</p>
`,type:"'partial' | 'always'",required:!1,default:"'partial'"}]}),e(o,{data:[{name:"closeAutoFocus",description:`<p>Event handler called when auto-focusing on close.
Can be prevented.</p>
