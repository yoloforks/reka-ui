import{_ as a,c as r,e,au as t,o as s}from"./chunks/framework.6UEeBrHH.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/ContextMenuCheckboxItem.md","filePath":"meta/ContextMenuCheckboxItem.md","lastUpdated":1741142384000}'),d={name:"meta/ContextMenuCheckboxItem.md"};function i(p,l,c,m,h,u){const n=t("PropsTable"),o=t("EmitsTable");return s(),r("div",null,[e(n,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
...
`,type:"[payload: boolean]"}]})])}const v=a(d,[["render",i]]);export{b as __pageData,v as default};
