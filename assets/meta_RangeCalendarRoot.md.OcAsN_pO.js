import{_ as d,c as i,e,au as a,o as l}from"./chunks/framework.BvEsjwOO.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/RangeCalendarRoot.md","filePath":"meta/RangeCalendarRoot.md","lastUpdated":1741141490000}'),s={name:"meta/RangeCalendarRoot.md"};function p(c,h,u,m,f,y){const t=a("PropsTable"),n=a("EmitsTable"),r=a("SlotsTable"),o=a("MethodsTable");return l(),i("div",null,[e(t,{data:[{name:"allowNonContiguousRanges",description:`<p>When combined with <code>isDateUnavailable</code>, determines whether non-contiguous ranges, i.e. ranges containing unavailable dates, may be selected.</p>
