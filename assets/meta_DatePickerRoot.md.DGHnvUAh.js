import{_ as r,c as i,e,au as t,o as d}from"./chunks/framework.BvEsjwOO.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/DatePickerRoot.md","filePath":"meta/DatePickerRoot.md","lastUpdated":1741141490000}'),s={name:"meta/DatePickerRoot.md"};function l(p,h,c,u,f,m){const a=t("PropsTable"),n=t("EmitsTable"),o=t("MethodsTable");return d(),i("div",null,[e(a,{data:[{name:"as",description:`<p>The element or component this component should render as. Can be overwritten by <code>asChild</code>.</p>
...
`,type:"[date: DateValue]"}]}),e(o,{data:[{name:"isDateDisabled",description:`<p>A function that returns whether or not a date is disabled</p>
`,type:"Matcher"},{name:"isDateUnavailable",description:`<p>A function that returns whether or not a date is unavailable</p>
`,type:"Matcher"}]})])}const g=r(s,[["render",l]]);export{b as __pageData,g as default};
