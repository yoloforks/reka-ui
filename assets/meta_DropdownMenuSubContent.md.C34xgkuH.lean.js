import{_ as i,c as a,e,au as n,o as r}from"./chunks/framework.6UEeBrHH.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{"sidebar":true},"headers":[],"relativePath":"meta/DropdownMenuSubContent.md","filePath":"meta/DropdownMenuSubContent.md","lastUpdated":1741142901000}'),s={name:"meta/DropdownMenuSubContent.md"};function d(p,l,c,h,u,m){const t=n("PropsTable"),o=n("EmitsTable");return r(),a("div",null,[e(t,{data:[{name:"alignOffset",description:`<p>An offset in pixels from the <code>start</code> or <code>end</code> alignment options.</p>
